...
<body>
	...
	<p>${cod}</p>
        ...
        <form method="post" action="ModificarUsuarios">
            ...
            <label for="email">Correo Electrónico</label><input type="text" name="email" value="${UsuarioAModificar.getEmail()}"/><br/>
            <label for="password">Contraseña </label> <input type="text" name="password" value="${UsuarioAModificar.getContraseña()}"/><br/>
            <label for="nombreReal">Nombre</label><input type="text" name="nombreReal" value="${UsuarioAModificar.getNombreReal()}"/><br/>
            <label for="apellidos">Apellidos</label><input type="text" name="apellidos" value="${UsuarioAModificar.getApellidos()}"/><br/>
             <br/>
